...
from TheHanCock.utils import Media, get_file_details, get_size
...
async def cbrules(_, query: CallbackQuery):
    await query.answer(
        f"""⚠️ ɪᴍᴘᴏʀᴛᴀɴᴛ ᴍᴇssᴀɢᴇ ʀᴇᴀᴅ
sᴇɴᴅ ᴇxᴀᴄᴛ ɴᴀᴍᴇ ᴀɴᴅ ɪғ ᴍᴏᴠɪᴇ ɴᴏᴛ ғᴏᴜɴᴅ ɪɴ ғɪʀsᴛ ᴘᴀɢᴇ ᴛʜᴇɴ ᴛʀʏ ɴᴇxᴛ ᴘᴀɢᴇ
